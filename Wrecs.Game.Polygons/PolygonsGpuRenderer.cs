...
/// <summary>
/// Batches the game's circles into a single SDL_GPU vertex buffer and draw call.
/// </summary>
sealed class PolygonsGpuRenderer : IDisposable
{
    ...
    public PolygonsGpuRenderer(nint window, int logicalWidth, int logicalHeight)
    {
        _window = window;
